package com.itc.ts8209a.module.font;
...
//                Log.e("FontManager","Font "+FILE[i]+"load fail : "+e);
    ...
    public class Picker{
        private CheckSelectorDialog pickDialog  = null;
        private pickerConfirmListener listener = null;
        private boolean[] checked;

        public void show(Context context){
            pickDialog = new CheckSelectorDialog(context,NAME);
            pickDialog.setTitle("字体设置").setMode(CheckSelectorDialog.SINGLE_SELECTION).setChecked(checked).show();
            pickDialog.setOnSelectConfirmListener(new CheckSelectorDialog.OnSelectConfirmListener() {
