...
//        this.title = "   点击色环选择颜色;下方选择色调;点击中心确定选择";
        this.title = "   " + context.getResources().getString(R.string.color_picker_title);
//        this.requestWindowFeature(Window.FEATURE_NO_TITLE);
//        this.getWindow().getAttributes().alpha = 0.8f;
        this.getWindow().setBackgroundDrawableResource(R.drawable.bg_dd574b3f_r);
    }
...
//        int height = (int) (manager.getDefaultDisplay().getHeight() * 0.8f);
...
//        super.requestWindowFeature(0x01);
    ...
    private class ColorPickerView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            //移动中心
            canvas.translate(mWidth / 2+30, mHeight / 2 - 60);
            //画中心圆
        ...
        public boolean onTouchEvent(MotionEvent event) {
            float x = event.getX() - mWidth / 2 - 30;
            float y = event.getY() - mHeight / 2 + 60;
