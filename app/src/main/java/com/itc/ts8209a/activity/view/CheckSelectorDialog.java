...
public class CheckSelectorDialog extends Dialog {
    ...
    public CheckSelectorDialog(Context context, String[] content) {
        super(context, R.style.custom_dialog);

        this.context = context;

        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        dialogLayout = inflater.inflate(R.layout.dialog_check_selector,null);


        btnConfirm = (Button)dialogLayout.findViewById(R.id.checkselector_dialog_confirm_btn);
        layContent = (LinearLayout)dialogLayout.findViewById(R.id.checkselector_dialog_content_lay);
        tvTitle = (TextView)dialogLayout.findViewById(R.id.checkselector_dialog_title_tv);
        cbSelectAll = (CheckBox)dialogLayout.findViewById(R.id.checkselector_dialog_check_all_cb);
    ...
    public CheckSelectorDialog setChecked(boolean[] checked){
...
//	}
    ...
    public CheckSelectorDialog setTitle(String title){
        tvTitle.setText(title);
        return this;
    }

    public CheckSelectorDialog setMode(int mode){
        selectMode = mode;
        modeConfig();
        return this;
    }
    ...
    public interface OnSelectConfirmListener{
        void multiSelect(boolean[] checked,String[] content);
        void singleSelect(int choice,String content);
    }

    public CheckSelectorDialog setOnSelectConfirmListener(OnSelectConfirmListener listener){
